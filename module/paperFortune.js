...
module.exports = controller => {
	...
	// Model
	//=========================================================
	global.paperFortuneMaccoto = function(data) {
		const paperFortuneResult = mtRandom([
		...
		paperFortuneView(data, paperFortuneResult)
	}
	global.paperFortuneKichi = function(data) {
		const paperFortuneResult = mtRandom([
			'*大吉* いい日になるよいいねー',
	...
	// View
	//=========================================================
	global.paperFortuneView = function(data, paperFortuneResult) {
		data.bot.reply(data.message, paperFortuneResult)
	}
}